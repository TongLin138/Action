...
from .. import tgbot, chat_id, logger, BOT_SET, ch_name
from .utils import cmd

@tgbot.on(events.NewMessage(from_users=chat_id, pattern=(r'^/beaninfo')))
...
if ch_name:
    tgbot.add_event_handler(beaninfo, events.NewMessage(
